def divide(quotients, divisors):
    ...
    """
    return {num: [divisor for divisor in divisors if divisor % num == 0] for num in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    what = make_city('what', lat, lon)
    distance_a = distance(what, city_a)
    distance_b = distance(what, city_b)
